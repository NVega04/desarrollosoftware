...
CREATE TABLE `insumos` (
  ...
  KEY `fk_insumo_medida` (`id_medida`),
  KEY `fk_insumo_proveedor` (`id_proveedor`),
  CONSTRAINT `fk_insumo_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `categorias` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_insumo_medida` FOREIGN KEY (`id_medida`) REFERENCES `medidas` (`id`) ON DELETE RESTRICT,
...
CREATE TABLE `produccion` (
  ...
  CONSTRAINT `fk_prod_recipe` FOREIGN KEY (`id_receta`) REFERENCES `recetario` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `recetario` (
  ...
  `id_categoria` int DEFAULT NULL,
  `rendimiento` decimal(18,4) DEFAULT '1.0000',
  `notas` text,
  ...
  KEY `fk_recipe_categoria` (`id_categoria`),
  KEY `fk_recipe_usuario` (`creado_por`),
  CONSTRAINT `fk_recipe_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `categorias` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_recipe_producto` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_recipe_usuario` FOREIGN KEY (`creado_por`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-11-19 16:23:58
